...
class ProfileScreen extends StatefulWidget {
  const ProfileScreen({Key? key, this.disableScaffold = false})
      : super(key: key);
...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget loaded() {
    ...
    return Scaffold(
        ...
        body: SingleChildScrollView(
            padding: const EdgeInsets.all(30.0), child: content(context)));
  }
  ...
  Widget content(BuildContext context) {
    return Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
      ...
      const SizedBox(height: 32.0),
      GradientButton(
          text: "${developerExpanded ? "Hide" : "Show"} developer options",
          onPressed: () {
            setState(() {
                      ...
                      return AlertDialog(
                          ...
                          actions: [
                            ...
                            TextButton(
                                ...
                                onPressed: () {
                                  serviceLocator<SleepCheckinService>().reset();
                                  serviceLocator<SharedPreferences>()
                                      .remove('data-sleep');
                                  serviceLocator<LoggingService>()
                                      .createLog("sleep", {"reset": true});
                                  serviceLocator<SharedPreferences>()
                                      .remove('sleep');
                                  serviceLocator<SharedPreferences>()
                                      .remove('review-force');
                          ...
                          actions: [
                            ...
                            TextButton(
                                ...
                                onPressed: () {
                                  ...
                                  serviceLocator<SleepCheckinService>().add(s);
                                  Navigator.of(context).pop();
                                }),
                          ]);
                    });
                      ...
                      return AlertDialog(
                          ...
                          actions: [
                            ...
                            TextButton(
                                child: const Text("Yes"),
                                onPressed: () {
                                  kvDelete("sleep", "diary-reminder-times");
                                  Navigator.of(context).pop();
                                }),
                          ]);
                    });
